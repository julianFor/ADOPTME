...
const NavbarFundacion = () => {
  ...
  const renderProfileModal = () => {
    ...
    return (
      <div className="absolute top-20 right-8 bg-white shadow-lg rounded-xl p-6 w-80 z-50">
        {!editing ? (
          <>
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-gray-500 mb-1">Rol: {user.role}</p>
                ...
                <button
                  className="border border-gray-400 px-4 py-2 rounded text-gray-800 hover:bg-gray-100"
                  onClick={logoutUser}
                >
                  Cerrar Sesión
                </button>
  ...
  return (
    <header className="flex justify-between items-center px-8 py-4 bg-white rounded-full shadow-md max-w-[1200px] mx-auto relative">
      ...
      <nav className="flex gap-6 text-lg font-medium">
        ...
        <Link to="/dashboard/fundacion" className="text-gray-700 hover:text-purple-600">Gestión</Link>
      </nav>
