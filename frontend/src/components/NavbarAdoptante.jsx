  ...
  return (
    <header className="flex justify-between items-center px-8 py-4 bg-white rounded-full shadow-md max-w-[1200px] mx-auto relative">
      ...
      <nav className="flex gap-6 text-lg font-medium">
        ...
        <Link to="/dashboard/adoptante" className={`pb-1 ${location.pathname === '/dashboard/adoptante' ? 'text-purple-600 border-b-2 border-purple-500' : 'text-gray-700 hover:text-purple-600'}`}>Gestión</Link>
      </nav>
